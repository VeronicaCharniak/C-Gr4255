...
// Стандартный, востроенный в Windows метод
// int[] outArr = new int[arr.Length]; - создаем ячейку памяти для нового массива
// arr.CopyTo(outArr,0); - копируем: в скобках 1 - куда вкладываем, 2 - с какого элемента начинаем копирование
// Print1DArr(outArr);
